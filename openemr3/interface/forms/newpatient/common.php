        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <?php } ?>
                    ...
                    <fieldset>
                        <legend><?php echo xlt('Details')?></legend>
                            <div class="form-group">
                                <div class="col-sm-10 col-sm-offset-1">
                                    <textarea name="details" id="details" class="form-control" cols="80" rows="4" ><?php echo $viewmode ? text($result['details']) : text($GLOBALS['default_chief_complaint']); ?></textarea>
                                </div>
                            </div>
                    </fieldset>
                    <fieldset>
