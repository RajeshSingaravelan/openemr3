...
<?php $userSetting = sqlQuery("select * from user_settings  where  setting_label='global:gbl_pt_list_new_window' ",'');?>
<!--    <?php print_r($userSetting)?> -->
...
<script type="text/javascript">
    ...
    app_view_model.application_data.user(new user_data_view_model(<?php echo json_encode($_SESSION{"authUser"})
        ...
        .',' . json_encode($userSetting['setting_value']); ?>));
