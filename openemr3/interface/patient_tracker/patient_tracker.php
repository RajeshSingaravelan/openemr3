                                ...
                                <table class="table-hover table-condensed" style="margin:0 auto;">
                                    ...
                                    <tr>
                                        <td class="text-center" colspan="2">
                                            ...
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><?php echo xlt('Add'); ?></button>
...
if (!$_REQUEST['flb_table']) { ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Doctor's List</h5>
  ...
  <?php
    ...
    <tr>
      ...
      <td><a class="btn btn-info" href="view.php?id=<?php echo $row['id'];?>">View</a></td>
    </tr>
    <?php } ?>      
  </tbody>
</table>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Doctor's Details</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
