...
?>
  ...
  <tr><td><span class="text"><?php echo xlt('Email'); ?>: </span></td><td>  <input type=entry name='email' id='email'  value="<?php echo attr($iter["email"]);?>" style="width:120px;" class="form-control"><span class="mandatory"></span></td>
