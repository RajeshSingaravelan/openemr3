...
//     alert(/([A-Z0-9a-z_-][^@])+?@[^$#<>?]+?\.[\w]{2,4}/.test(email));
//   }
// });
...
?>
  ...
  <tr><td><span class="text"><?php echo xlt('Email'); ?>: </span></td><td>  <input type=entry name='email' id='email'  style="width:120px;" class="form-control"><span class="mandatory"></span></td>
