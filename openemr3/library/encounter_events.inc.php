...
function update_event($eid)
{
  ...
  // no recurr specs, this is used for adding a new non-recurring event
    ...
    // this event is forced to NOT REPEAT
        ...
        $args['appointment_type']=$origEvent['appointment_type'];
...
function InsertEvent($args, $from = 'general')
{
    ...
    if ($from == 'general') {
        $pc_eid = sqlInsert(
            ...
            "pc_apptstatus, pc_prefcatid, pc_location, pc_eventstatus,  pc_sharing, pc_facility,pc_billing_location,pc_room ,appointment_type" .
            ") VALUES (?,?,?,?,?,?,NOW(),?,?,?,?,?,?,?,?,?,?,?,?,?,1,1,?,?,?,?)",
            ...
            $args['locationspec'],(int)$args['facility'],(int)$args['billing_facility'],$form_room,$_POST['appointment_type'])
        );
        ...
        sqlStatement(
            ...
            "pc_recurrspec, pc_startTime, pc_endTime, pc_alldayevent, " .
            "pc_apptstatus, pc_prefcatid, pc_location, pc_eventstatus,pc_sharing,pc_facility,pc_billing_location,appointment_type" .
            ") VALUES (?,?,?,?,?,NOW(),?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
            ...
            1,
            (int)$args['facility'],
            (int)$args['billing_facility'],$_POST['appointment_type'])
        );
    }
}
//================================================================================================================
