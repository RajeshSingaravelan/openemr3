<?php /* Smarty version 2.6.31, created on 2022-08-17 17:43:13
         compiled from default/views/month_print/outlook_ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/month_print/outlook_ajax_template.html', 10, false),array('function', 'headerTemplate', 'default/views/month_print/outlook_ajax_template.html', 200, false),array('modifier', 'date_format', 'default/views/month_print/outlook_ajax_template.html', 244, false),array('modifier', 'string_format', 'default/views/month_print/outlook_ajax_template.html', 245, false),)), $this); ?>
...
.timeslot {
    height: <?php echo attr($timeslotHeightVal.$timeslotHeightUnit); ?>;
    margin: 0px;
    padding: 0px;
}
.schedule {
...
<?php echo smarty_function_headerTemplate(array('assets' => 'no_bootstrap|no_fontawesome|no_main-theme|no_textformat|no_dialog'), $this);?>
...
foreach ($providers as $provider) {
    ...
    foreach ($A_EVENTS as $date => $events) {
	    ...
	    $fname = substr($event['patient_name'], $commapos + 2);
            ...
            echo "<div class='" . attr($evtClass) . "' style='background-color:" . attr($event['catcolor']) . ";'>";
            echo $content;
            echo "</div>\n";
        } // end EVENT loop
