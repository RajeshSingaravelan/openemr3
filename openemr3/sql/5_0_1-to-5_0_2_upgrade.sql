...
SET
    `require_once` = '/library/MedEx/MedEx_background.php'
WHERE `name` = 'MedEx';
...
#EndIf
#IfNotTable form_doctor_details
CREATE TABLE
    `form_doctor_details`(
        ...
        PRIMARY KEY `doctor_details_link` (`id`)
    ) ENGINE = InnoDB;

#IfNotTable form_sample
CREATE TABLE
    `form_sample` (
        `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Links to forms.form_id',
        `name` varchar(255) DEFAULT NULL,
        PRIMARY KEY `sample_link` (`id`)
    ) ENGINE = InnoDB;
...
ALTER TABLE
    `form_eye_mag_orders` CHANGE `id` `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
    CHANGE `ORDER_PID` `pid` BIGINT(20) NOT NULL,
ADD
    `form_id` bigint(20) NOT NULL AFTER `id`,
DROP INDEX `VISIT_ID`;
...
VALUES (
        ...
        'b23e0128eb2dce0cb007c31638a8dc00'
    );
...
VALUES (
        ...
        'eb545fe61ada9efad0ad97a669f8671f'
    );
...
ADD
    COLUMN `last_challenge_response` datetime DEFAULT NULL;

#EndIf
#IfMissingColumn users_secure login_work_area
ALTER TABLE `users_secure`
ADD
    COLUMN `login_work_area` text;

#EndIf
#IfNotColumnType onsite_messages sender_id VARCHAR(64)
ALTER TABLE
    `onsite_messages` CHANGE `sender_id` `sender_id` VARCHAR(64) NULL COMMENT 'who sent id';
...
ADD
    COLUMN `CTLODQUANTITY` varchar(255) DEFAULT NULL;
...
ALTER TABLE
    `form_eye_mag_dispense`
ADD
    COLUMN `CTLOSQUANTITY` varchar(255) DEFAULT NULL;
...
UPDATE `list_options`
SET
    `notes` = '{"form_title":{"presence": true}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'add_edit_issue#theform';

UPDATE `list_options`
SET
    `notes` = '{"pc_catid":{"exclusion": ["_blank"]}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'common#new_encounter';

UPDATE `list_options`
SET
    `notes` = '{"form_patient":{"presence": {"message": "Patient Name Required"}}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'add_edit_event#theform';

UPDATE `list_options`
SET
    `notes` = '{"rumple":{"presence": {"message":"Required field missing: Please enter the User Name"}}, "stiltskin":{"presence": {"message":"Please enter the password"}}, "fname":{"presence": {"message":"Required field missing: Please enter the First name"}}, "lname":{"presence": {"message":"Required field missing: Please enter the Last name"}}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'usergroup_admin_add#new_user';

UPDATE `list_options`
SET
    `notes` = '{"fname":{"presence": {"message":"Required field missing: Please enter the First name"}}, "lname":{"presence": {"message":"Required field missing: Please enter the Last name"}}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'user_admin#user_form';

UPDATE `list_options`
SET
    `notes` = '{"facility":{"presence": true}, "ncolor":{"presence": true}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'facility_admin#facility-form';
...
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'facilities_add#facility-add';

UPDATE `list_options`
SET
    `notes` = '{"group_name":{"presence": true}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'therapy_groups_add#addGroup';
...
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'therapy_groups_edit#editGroup';

UPDATE `list_options`
SET
    `notes` = '{"participant_name":{"presence": true}, "group_patient_start":{"presence": true}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'tg_add#add-participant-form';
...
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'common#new-encounter-form';

UPDATE `list_options`
SET
    `notes` = '{"form_group":{"presence": true}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'add_edit_event#theform_groups';

UPDATE `list_options`
SET
    `notes` = '{"form_datetime":{"futureDate":{"message": "Must be future date"}}, "reply_to":{"presence": {"message": "Please choose a patient"}}}'
WHERE
    `list_id` = 'page_validation'
    AND `option_id` = 'messages#new_note';
...
ALTER TABLE
    `onsite_documents` CHANGE `full_document` `full_document` MEDIUMBLOB;
...
ALTER TABLE
    `amendments` MODIFY `pid` bigint(20) NOT NULL COMMENT 'Patient ID from patient_data';

#EndIf
#IfNotColumnType billing pid bigint(20)
ALTER TABLE
    `billing` MODIFY `pid` bigint(20) default NULL;

#EndIf
#IfNotColumnType dated_reminders pid bigint(20)
ALTER TABLE
    `dated_reminders` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType drug_sales pid bigint(20)
ALTER TABLE
    `drug_sales` MODIFY `pid` bigint(20) NOT NULL default '0';

#EndIf
#IfNotColumnType form_ros pid bigint(20)
ALTER TABLE
    `form_ros` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType issue_encounter pid bigint(20)
ALTER TABLE
    `issue_encounter` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType onsite_documents pid bigint(20) unsigned
ALTER TABLE
    `onsite_documents` MODIFY `pid` bigint(20) UNSIGNED default NULL;

#EndIf
#IfNotColumnType patient_access_onsite pid bigint(20)
ALTER TABLE
    `patient_access_onsite` MODIFY `pid` bigint(20);

#EndIf
#IfNotColumnType patient_access_offsite pid bigint(20)
ALTER TABLE
    `patient_access_offsite` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType form_eye_mag_wearing PID bigint(20)
ALTER TABLE
    `form_eye_mag_wearing` MODIFY `PID` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType therapy_groups_participants pid bigint(20)
ALTER TABLE
    `therapy_groups_participants` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType therapy_groups_participant_attendance pid bigint(20)
ALTER TABLE
    `therapy_groups_participant_attendance` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType notification_log pid bigint(20)
ALTER TABLE
    `notification_log` MODIFY `pid` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType documents foreign_id bigint(20)
ALTER TABLE
    `documents` MODIFY `foreign_id` bigint(20) default NULL;

#EndIf
#IfNotColumnType batchcom patient_id bigint(20)
ALTER TABLE
    `batchcom` MODIFY `patient_id` bigint(20) NOT NULL default '0';

#EndIf
#IfNotColumnType claims patient_id bigint(20)
ALTER TABLE
    `claims` MODIFY `patient_id` bigint(20) NOT NULL;

#EndIf
#IfNotColumnType immunizations patient_id bigint(20)
ALTER TABLE
    `immunizations` MODIFY `patient_id` bigint(20) default NULL;

#EndIf
#IfNotColumnType prescriptions patient_id bigint(20)
ALTER TABLE
    `prescriptions` MODIFY `patient_id` bigint(20) default NULL;

#EndIf
#IfNotColumnType ar_session patient_id bigint(20)
ALTER TABLE
    `ar_session` MODIFY `patient_id` bigint(20) NOT NULL;
...
VALUES (
        ...
        'NIH_VSAC',
        '2017-09-29',
        'ep_ec_only_cms_20170929.xml.zip',
        '38d2e1a27646f2f09fcc389fd2335c50'
    );

#EndIf
#IfNotColumnType eligibility_verification response_id varchar(32)
ALTER TABLE
    `eligibility_verification` CHANGE `response_id` `response_id` VARCHAR(32) DEFAULT NULL;
...
ALTER TABLE
    `x12_partners` CHANGE `processing_format` `processing_format` ENUM(
        'standard',
        'medi-cal',
        'cms',
        'proxymed',
...
ADD
    `x12_dtp03` CHAR(1) DEFAULT 'A';

#EndIf
#IfMissingColumn procedure_order order_diagnosis
ALTER TABLE `procedure_order`
ADD
    `order_diagnosis` VARCHAR(255) DEFAULT '';

#EndIf #IfTable erx_drug_paid DROP TABLE `erx_drug_paid`;
...
#EndIf #IfTable array DROP TABLE `array`;

#EndIf #IfTable config DROP TABLE `config`;

#EndIf #IfTable config_seq DROP TABLE `config_seq`;
...
#EndIf #IfTable geo_zone_reference DROP TABLE `geo_zone_reference`;
...
SET `seq` = 1022
WHERE
    `list_id` = 'Eye_QP_RETINA_defaults'
    AND `option_id` = 'ODPERIPH_0';

UPDATE `list_options`
SET `seq` = 1024
WHERE
    `list_id` = 'Eye_QP_RETINA_defaults'
    AND `option_id` = 'OSPERIPH_0';

UPDATE `list_options`
SET `seq` = 1026
WHERE
    `list_id` = 'Eye_QP_RETINA_defaults'
    AND `option_id` = 'OUPERIPH_0';
...
SET
    ...
    `seq` = 505
WHERE
    `list_id` = 'Eye_Defaults_for_GENERAL'
    AND `option_id` = 'ODPERIPH';
...
#EndIf 
#IfMissingColumn openemr_postcalendar_events appointment_type
ALTER TABLE
...
#EndIf
#IfMissingColumn form_encounter details
...
#EndIf
#IfMissingColumn form_doctor_details date
ALTER TABLE
    `form_doctor_details`
ADD `date` date default NULL;

#EndIf
#IfMissingColumn form_doctor_details image
ALTER TABLE
    `form_doctor_details`
ADD
...
#EndIf
#IfMissingColumn form_sample fname
ALTER TABLE `form_sample`
ADD
    `fname` varchar(255) default NULL;

#EndIf
#IfMissingColumn form_sample firstname
ALTER TABLE `form_sample`
ADD
...
#IfMissingColumn form_sample date
ALTER TABLE `form_sample`
ADD
...
#IfMissingColumn form_sample gender
ALTER TABLE `form_sample`
ADD
...
#IfNotTable patient_records
CREATE TABLE
    `patient_records`(
        `p_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Links to forms.form_id',
        `name` varchar(255) DEFAULT NULL,
        ...
        PRIMARY KEY `patient_records_link` (`p_id`)
    ) ENGINE = InnoDB;

#EndIf 

#IfMissingColumn patient_records un_id
